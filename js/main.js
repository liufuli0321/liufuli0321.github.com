...
var duoshuoName = '邂逅一片天'; // change to your DUOSHUO name
var duoshuoQuery = {short_name: 邂逅一片天}; // change to your duoshuo name
function toggleDuoshuoComments(container) {
    ...
    el.setAttribute('data-author-key', 邂逅一片天); // change to your duoshuo name
